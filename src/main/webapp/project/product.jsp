		...
		<div class="container">
				...
				<div class="flex-w flex-l-m filter-tope-group m-tb-10">
					...
					<c:forEach var="category" items="${categories}">
						<button class="stext-106 cl6 hov1 bor3 trans-04 m-r-32 m-tb-5"
							data-filter=".<c:out value='${category.description}' />">
			...
			<div class="row isotope-grid">
				<c:if test="${listSearch != null}">
					<c:set var="list" value="${listSearch}"></c:set>
				</c:if>
				<c:if test="${products != null}">
					<c:set var="list" value="${products}"></c:set>
				</c:if>
				<c:forEach var="product" items="${list}">
					<div
						class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item <c:out value='${product.category.description}' />">

						<!-- Block2 -->
						<div class="block2">
							<div class="block2-pic hov-img0">
								<img src="<c:out value='${pageContext.request.contextPath}/uploads/${product.image}' />" alt="IMG-PRODUCT">
