			...
			<div class="row">
				...
				<div class="col-sm-10 col-lg-7 col-xl-5 m-lr-auto m-b-50">
					<div
						...
						<c:if test="${sessionScope.cart.size() > 0 and status.equals(order) }">
						<a href="${pageContext.request.contextPath}/cart?action=checkout"><button
								class="flex-c-m stext-101 cl0 size-116 bg3 bor14 hov-btn3 p-lr-15 trans-04 pointer">
								Order Now</button></a>
						</c:if>
						
						<c:if test="${status.equals(view)and sessionScope.cart.size() > 0}">
						<a href="${pageContext.request.contextPath}/CheckOutServlet"><button
								class="flex-c-m stext-101 cl0 size-116 bg3 bor14 hov-btn3 p-lr-15 trans-04 pointer">
								Order Now</button></a>
						</c:if>
