...
<body class="animsition">
						...
						<div class="wrap-slick3 flex-sb flex-w">
							...
							<div class="slick3 gallery-lb">
								<div class="item-slick3"
									data-thumb="<c:out value='${pageContext.request.contextPath}/uploads/${product.image}' />">
									<div class="wrap-pic-w pos-relative">
										<img
											src="<c:out value='${pageContext.request.contextPath}/uploads/${product.image}' />"
											alt="IMG-PRODUCT"> <a
											class="flex-c-m size-108 how-pos1 bor0 fs-16 cl10 bg0 hov-btn3 trans-04"
											href="<c:out value='${pageContext.request.contextPath}/uploads/${product.image}' />">
						...
						<div class="p-t-33">
							...
							<div class="flex-w flex-r-m p-b-10">
								<div class="size-204 flex-w flex-m respon6-next">
									...
									<a
										href="${pageContext.request.contextPath}/cart?id=${product.id}&action=add"><button
			...
			<div class="bor10 m-t-50 p-t-43 p-b-40">
				...
				<div class="tab01">
					...
					<ul class="nav nav-tabs" role="tablist">
						...
						<li class="nav-item p-b-10"><a class="nav-link"
						data-toggle="tab" href="#reviews" role="tab">Reviews(${sumrv})</a></li> 
					</ul>
							...
							<div class="row">
								<div class="col-sm-10 col-md-8 col-lg-6 m-lr-auto">
									<div class="p-b-30 m-lr-15-sm">
										<!-- Review -->
										 <c:forEach items="${listreview}" var="itemReview">
											<div class="flex-w flex-t p-b-68">
												<div class="wrap-pic-s size-109 bor0 of-hidden m-r-18 m-t-6">
													<img						
														src="<c:out value='${pageContext.request.contextPath}/uploads/${itemReview.getUser().getImage()}' />"
														alt="IMG-PRODUCT"> 
												</div>
	
												<div class="size-207">
													<div class="flex-w flex-sb-m p-b-17">
														<span class="mtext-107 cl2 p-r-20"> ${itemReview.getUser().getName()} </span> 
														<span class="fs-18 cl11"> 															
		                                                        <c:set var="starReview" scope="session"
		                                                               value="${itemReview.getSosao()}" />
													...
													<p class="stext-102 cl6">${itemReview.getComment()}</p>
												</div>
											</div>
										</c:forEach>

										<!-- Add review -->
										<form class="w-full" action="${pageContext.request.contextPath}/ReviewServlet" method="post">
											...
											<button
												...
												id="btn_Review" class="btn btn-primary btn-hover-color-primary"
                                                            type="submit" value="${product.getId()}"
	...
	<section class="sec-relate-product bg0 p-t-45 p-b-105">
		<div class="container">
			...
			<div class="wrap-slick2">
				<div class="slick2">
				 	<c:forEach items="${productrelated}" var="item">
						<div class="item-slick2 p-l-15 p-r-15 p-t-15 p-b-15">
							<div class="block2">
								<div class="block2-pic hov-img0">
									<img
											src="<c:out value='${pageContext.request.contextPath}/uploads/${item.getImage()}' />"
											alt="IMG-PRODUCT"> 
										<a
								...
								<div class="block2-txt flex-w flex-t p-t-14">
									<div class="block2-txt-child1 flex-col-l ">
										<a href="${pageContext.request.contextPath}/detail?pid=<c:out
											value="${item.getId()}" />"
											class="stext-104 cl4 hov-cl1 trans-04 js-name-b2 p-b-6">
											${item.getName()} </a> <span class="stext-105 cl3">
											${item.getPrice()} </span>
									</div>
	...
	<script>
		 function disableReview() {
	        var UserId = ${empty sessionScope.user.id ? -1 : sessionScope.user.id};
	        if (UserId === -1) {
